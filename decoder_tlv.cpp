 ...
 * возвращаемое значение - длина данных
 * байт(-ы) длины данных после определения, удаляются из массива TLV
 * (не реализована неопределенная длина)
*/
...
/*
 *Определение формата даных, вывод данных.
 *Байт(-ы) данных после определения, удалчютсч из массива TLV
*/
...
/*
 *Определение тега, поиск в карте тегов.
 *при отсутвии в карте тегов - отбражается как "Unknown tag"
 *байт(-ы) тега после определения, удаляются из массива TLV
*/
