 ...
 * байт(-ы) длины данных после определени€, удал€ютс€ из массива TLV
 ...
 *Ѕайт(-ы) данных после определени€, удалчютсч из массива TLV
*/
 ...
 *при отсутвии в карте тегов - отбражаетс€ как "Unknown tag"
 *байт(-ы) тега после определени€, удал€ютс€ из массива TLV
*/
